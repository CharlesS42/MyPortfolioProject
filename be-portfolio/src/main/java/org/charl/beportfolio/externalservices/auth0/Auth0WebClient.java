...
import org.charl.beportfolio.externalservices.auth0.models.*;
...
public class Auth0WebClient implements Auth0Service {
    ...
    private UserResponseModel mapToUserResponseModel(
        ...
        return UserResponseModel.builder()
                ...
                .fullName(auth0User.getFirstName() + " " + auth0User.getLastName())
                .email(auth0User.getEmail())
                .role(roleNames.isEmpty() ? null : roleNames.get(0)) // Assuming single role
                .build();
    }
